    ...
    const buildProject = new PipelineProject(this, 'BuildStageProject', {
      buildSpec: BuildSpec.fromObject({
        ...
        phases: {
          ...
          build: {
            commands: ['echo Build started on `date`', 'yarn build', 'yarn cdk synth'],
          },
          post_build: {
    ...
    const deployProject = new PipelineProject(this, 'DeployStageProject', {
      buildSpec: BuildSpec.fromObject({
        ...
        phases: {
          ...
          build: {
            commands: ['echo Deploy started on `date`', 'cdk deploy --app cdk.out'],
          },
          post_build: {
